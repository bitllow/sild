...
/** Lucide-style stroked icon base — 2px round caps, currentColor. */
...
export const GoogleMark = (p: React.SVGProps<SVGSVGElement>) => (
  <svg width="18" height="18" viewBox="0 0 24 24" {...p}>
    ...
    <path fill="#EA4335" d="M12 5.4c1.6 0 3 .5 4.1 1.6l3.1-3.1A11 11 0 0 0 2.3 7.4l3.7 2.8c.9-2.6 3.2-4.8 6-4.8z" />
  </svg>
);
